...
title @a title {"text":""}
tellraw @a ["",{"text":"\u25b6","bold":true},{"text":" The game begins!","bold":true,"color":"dark_green"},{"text":" Right-click","color":"yellow"},{"text":" your ","color":"gold"},{"text":"magma cream","color":"yellow"},{"text":" and select your class.","color":"gold"}]
