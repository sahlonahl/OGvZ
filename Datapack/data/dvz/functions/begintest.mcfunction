...
execute if entity @e[tag=worldspawn,distance=..10000] store success score @s DVZ.begintest run tellraw @s {"text":"Found Spawn-in Lobby.","color":"green"}
...
scoreboard players set @s DVZ.begintest 0
execute if entity @e[tag=dSpawn,distance=..10000] store success score @s DVZ.begintest run tellraw @s {"text":"Found Dwarf Spawn.","color":"aqua"}
execute if entity @s[scores={DVZ.begintest=0}] run tellraw @s {"text":"COULD NOT FIND Dwarf Spawn.","bold":true,"color":"dark_aqua"}
tag @s[scores={DVZ.begintest=0}] add begintestfail

execute if entity @e[type=marker,tag=dSpawn,distance=..10000] run scoreboard players set @s DVZ.begintest 0
...
scoreboard players set @s DVZ.begintest 0
execute if entity @e[tag=zSpawn,distance=..10000] store success score @s DVZ.begintest run tellraw @s {"text":"Found Zombie Spawn.","color":"red"}
execute if entity @s[scores={DVZ.begintest=0}] run tellraw @s {"text":"COULD NOT FIND Zombie Spawn.","bold":true,"color":"dark_red"}
tag @s[scores={DVZ.begintest=0}] add begintestfail

scoreboard players set @s DVZ.begintest 0
execute if entity @e[tag=dvztimer,tag=selected,distance=..10000] store success score @s DVZ.begintest run tellraw @s {"text":"Found Boss Selection.","color":"gray"}
...
execute if entity @s[tag=begintestfail] run tellraw @s {"text":"ALL COMPONENT MUST BE IN THE SAME DIMENSION!","bold":true,"italic":true,"underlined":true,"color":"gold"}
