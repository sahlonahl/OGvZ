...
xp add @s[tag=!selectedclass] 100 levels
...
give @s[tag=endermite,tag=!selectedclass] endermite_spawn_egg{display:{Name:'{"text":"Endermine - Debuff","color":"dark_purple","bold":false}',Lore:['{"text":"Explodes and debuffs dwarves","color":"gray","bold":false,"italic":false}','{"text":" when near a dwarf","color":"gray","bold":false,"italic":false}','{"text":"takes 3 seconds to set up!","color":"gray","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:10f,IsBaby:1b,Tags:["endermine","endermine_debuff"],ArmorItems:[{},{},{},{id:"minecraft:polished_blackstone_pressure_plate",Count:1b}],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:60,ShowParticles:1b}],Attributes:[{Name:generic.max_health,Base:10}]}} 5
give @s[tag=endermite,tag=!selectedclass] endermite_spawn_egg{display:{Name:'{"text":"Endermine - Summon","color":"dark_purple","bold":false}',Lore:['{"text":"Summons an endermite swarm","color":"gray","bold":false,"italic":false}','{"text":" when near a dwarf","color":"gray","bold":false,"italic":false}','{"text":"takes 3 seconds to set up!","color":"gray","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:10f,IsBaby:1b,Tags:["endermine","endermine_summon"],ArmorItems:[{},{},{},{id:"minecraft:heavy_weighted_pressure_plate",Count:1b}],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:60,ShowParticles:1b}],Attributes:[{Name:generic.max_health,Base:10}]}} 3
give @s[tag=endermite,tag=!selectedclass] endermite_spawn_egg{display:{Name:'{"text":"Endermine - Displace","color":"dark_purple","bold":false}',Lore:['{"text":"Teleports dwarves to a nearby monster","color":"gray","bold":false,"italic":false}','{"text":" when near a dwarf","color":"gray","bold":false,"italic":false}','{"text":"takes 5 seconds to set up!","color":"gray","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:10f,IsBaby:1b,Tags:["endermine","endermine_displace"],ArmorItems:[{},{},{},{id:"minecraft:warped_pressure_plate",Count:1b}],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:100,ShowParticles:1b}],Attributes:[{Name:generic.max_health,Base:10}]}} 3
