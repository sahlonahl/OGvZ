...
give @s[tag=endermite,tag=!selectedclass] endermite_spawn_egg{display:{Name:'{"text":"Endermine","color":"dark_purple","bold":false}',Lore:['{"text":"Explodes when near a dwarf","color":"gray","bold":false,"italic":false}','{"text":"takes 3 seconds to set up!","color":"gray","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,IsBaby:1b,Tags:["endermine"],HandItems:[{id:"minecraft:redstone_torch",Count:1b},{}],ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b}],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:60,ShowParticles:1b}]}} 3
...
execute as @s at @s run summon armor_stand ~ ~1.8 ~ {CustomNameVisible:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["endermite_tag"],CustomName:'[{"text":"Endermite","color":"blue","bold":false,"italic":false},{"text":", Totally a Dwarf","color":"blue","bold":false,"italic":true}]'}
