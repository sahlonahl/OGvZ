...
give @s[tag=evoker,tag=!selectedclass] golden_sword{display:{Name:'{"text":"Evoker Sword","color":"#D7B740","bold":false,"italic":false}'},Unbreakable:1b,Enchantments:[{id:"minecraft:sharpness",lvl:7s},{id:"minecraft:unbreaking",lvl:4s}]} 1
...
give @s[tag=evoker,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Summon Legion","color":"#D7B740"}',Lore:['{"text":"Summon 8 illager legionaries","color":"gray","bold":false,"italic":false}','{"text":"25 second cooldown!","color":"red","bold":false,"italic":false}','{"text":"Recast during cooldown to","color":"aqua","bold":false,"italic":false}','{"text":"teleport legionaries to you","color":"aqua","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:105} 1
give @s[tag=evoker,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Enchanted Ward","color":"#D7B740"}',Lore:['{"text":"Grant every allies nearby","color":"gray","bold":false,"italic":false}','{"text":"resistance and absorption","color":"gray","bold":false,"italic":false}','{"text":"35 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:107} 1
