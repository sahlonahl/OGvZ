...
give @s[tag=snowman,tag=!selectedclass] carrot_on_a_stick{CustomModelData:52,Unbreakable:1b,display:{Name:'{"text":"Snowball Barrage","color":"aqua"}',Lore:['[{"text":"Long-range snowball barrage!"}]','[{"text":"5 second cooldown.","color":"red"}]']}} 1
