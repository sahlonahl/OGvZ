...
give @s[tag=blaze,tag=!selectedclass] carrot_on_a_stick{CustomModelData:64,Unbreakable:1b,display:{Name:'{"text":"Explosive Fireball","color":"gold"}',Lore:['[{"text":"Fires an explosive fireball."}]','[{"text":"5 second cooldown!","color":"red"}]']}} 1
