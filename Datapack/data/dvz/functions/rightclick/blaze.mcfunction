...
give @s[tag=blaze,tag=!selectedclass] carrot_on_a_stick{CustomModelData:74,Unbreakable:1b,display:{Name:'{"text":"Explosive Fireball","color":"gold"}',Lore:['[{"text":"Fires an explosive fireball."}]','[{"text":"5 second cooldown!","color":"red"}]']}} 1
give @s[tag=blaze,tag=!selectedclass] fire_charge 64
give @s[tag=blaze,tag=!selectedclass] blaze_spawn_egg 8
give @s[tag=blaze,tag=!selectedclass] sponge 16
