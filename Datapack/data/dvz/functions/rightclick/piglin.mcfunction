...
give @s[tag=piglin,tag=!selectedclass] mooshroom_spawn_egg{display:{Name:'{"text":"Explosive Charge","color":"red","bold":false,"italic":false}',Lore:['{"text":"Can be detonated with a detonator","color":"gray","bold":false,"italic":false}','{"text":"takes 10 seconds to set up!","color":"red","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:10f,IsBaby:1b,Tags:["piglin_charge","endermine_explode"],CustomName:'{"text":"Explosive Charge","color":"red","bold":false,"italic":false}',ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b}],ArmorDropChances:[0.085F,0.085F,0.085F,-100.000F],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:200,ShowParticles:1b}],Attributes:[{Name:generic.max_health,Base:10}]}} 8
give @s[tag=piglin,tag=!selectedclass] mooshroom_spawn_egg{display:{Name:'{"text":"Enchanted Explosive Charge","color":"red","bold":false,"italic":false}',Lore:['{"text":"WARNING: EXPOSES ITSELF WHEN PLACED","color":"red","bold":false,"italic":false}','{"text":"Can be detonated with a detonator","color":"gray","bold":false,"italic":false}','{"text":"takes 15 seconds to set up!","color":"red","bold":false,"italic":false}']},EntityTag:{id:"minecraft:zombie",NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:10f,IsBaby:1b,Tags:["piglin_charge","endermine_explode_big"],CustomName:'{"text":"Enchanted Explosive Charge","color":"red","bold":false,"italic":false}',ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b,tag:{Enchantments:[{id:"minecraft:fire_aspect",lvl:1s}]}}],ArmorDropChances:[0.085F,0.085F,0.085F,-100.000F],ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999,ShowParticles:0b},{Id:18,Amplifier:0b,Duration:300,ShowParticles:1b},{Id:24,Amplifier:0b,Duration:60,ShowParticles:0b}],Attributes:[{Name:generic.max_health,Base:10}]}} 2
