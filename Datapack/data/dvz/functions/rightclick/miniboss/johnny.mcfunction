...
give @s[tag=johnny,tag=!selectedclass] iron_axe{CustomModelData:1,Unbreakable:1b,display:{Name:'{"text":"Johnny\'s Axe","color":"red"}'},Enchantments:[{id:"sharpness",lvl:7}]}
...
effect give @s[tag=johnny,tag=!selectedclass] strength infinite 1 true
