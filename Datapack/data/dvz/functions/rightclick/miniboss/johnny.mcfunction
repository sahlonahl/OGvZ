...
give @s[tag=johnny,tag=!selectedclass] iron_axe{CustomModelData:1,Unbreakable:1b,display:{Name:'{"text":"Johnny\'s Axe","color":"red"}'},Enchantments:[{id:"sharpness",lvl:5}]}
...
effect give @s[tag=johnny,tag=!selectedclass] regeneration 1000000 0 true
effect give @s[tag=johnny,tag=!selectedclass] speed 1000000 0 true
effect give @s[tag=johnny,tag=!selectedclass] strength 1000000 0 true
effect give @s[tag=johnny,tag=!selectedclass] health_boost 1000000 4 true
effect give @s[tag=johnny,tag=!selectedclass] haste 1000000 2 true
