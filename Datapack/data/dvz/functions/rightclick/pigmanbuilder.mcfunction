...
item replace entity @s[tag=pigman,tag=!selectedclass] armor.head with player_head{SkullOwner:"MHF_Pig",display:{Name:'{"text":"Hoglin Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:4},{id: "protection", lvl: 1},{id:"binding_curse",lvl:1}]} 1
item replace entity @s[tag=pigman,tag=!selectedclass] armor.chest with leather_chestplate{Unbreakable: 1b, display: {color: 14516085}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=pigman,tag=!selectedclass] armor.legs with leather_leggings{Unbreakable: 1b, display: {color: 14516085}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=pigman,tag=!selectedclass] armor.feet with leather_boots{Unbreakable: 1b, display: {color: 14516085}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
...
item replace entity @s[tag=builder,tag=!selectedclass] armor.chest with leather_chestplate{Enchantments: [{id: "fire_protection", lvl: 3}], display: {Name: '{"text":"Builder Chestplate","color":"green"}'}}
