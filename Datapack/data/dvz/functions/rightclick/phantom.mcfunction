...
item replace entity @s[tag=phantom,tag=!selectedclass] armor.head with player_head{SkullOwner:{Id:[I;-899131844,-1140113241,-1737191005,1607106852],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzQ2ODMwZGE1ZjgzYTNhYWVkODM4YTk5MTU2YWQ3ODFhNzg5Y2ZjZjEzZTI1YmVlZjdmNTRhODZlNGZhNCJ9fX0="}]}},display:{Name:'{"text":"Phantom Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:10},{id: "protection", lvl: 1},{id:"binding_curse",lvl:1}]} 1
item replace entity @s[tag=phantom,tag=!selectedclass] armor.chest with elytra{Unbreakable:1b,Enchantments:[{id: "protection", lvl: 1},{id:"minecraft:binding_curse",lvl:1s}]} 1
item replace entity @s[tag=phantom,tag=!selectedclass] armor.legs with leather_leggings{Unbreakable: 1b, display: {color: 2704794}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}], AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:-4,Operation:0,UUID:[I;-840866818,-21950756,-828424277,-758675542]}]} 1
item replace entity @s[tag=phantom,tag=!selectedclass] armor.feet with leather_boots{Unbreakable: 1b, display: {color: 2704794}, Enchantments: [{id: "feather_falling", lvl: 100}, {id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
