...
item replace entity @s[tag=witch,tag=!selectedclass] armor.head with player_head{display:{Name:'{"text":"witch Head","color":"dark_purple","bold":true,"italic":false}'},Enchantments:[{id:"minecraft:protection",lvl:3s},{id:"minecraft:blast_protection",lvl:4s},{id:"minecraft:binding_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:1,Operation:0,UUID:[I;1562552718,-1564914957,-1706359304,1560220886],Slot:"head"}],SkullOwner:{Id:[I;-805727641,296764545,-1227633676,-1637861893],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvN2U3MWE2ZWIzMDNhYjdlNmY3MGVkNTRkZjkxNDZhODBlYWRmMzk2NDE3Y2VlOTQ5NTc3M2ZmYmViZmFkODg3YyJ9fX0="}]}}} 1
item replace entity @s[tag=witch,tag=!selectedclass] armor.chest with leather_chestplate{display:{color:5308544},Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:3s},{id:"minecraft:blast_protection",lvl:4s},{id:"minecraft:binding_curse",lvl:1s}]} 1
item replace entity @s[tag=witch,tag=!selectedclass] armor.legs with leather_leggings{display:{color:5308544},Unbreakable: 1b, Enchantments: [{id:"minecraft:protection",lvl:3s},{id: "blast_protection", lvl: 4}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=witch,tag=!selectedclass] armor.feet with leather_boots{display:{color:5308544},Unbreakable: 1b, Enchantments: [{id:"minecraft:protection",lvl:3s},{id: "feather_falling", lvl: 2},{id: "blast_protection", lvl: 4},{id: "binding_curse", lvl: 1}]} 1
