...
item replace entity @s[tag=enderman,tag=!selectedclass] armor.head with player_head{SkullOwner:"MHF_Enderman",display:{Name:'{"text":"Enderman Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:4},{id: "protection", lvl: 1},{id:"binding_curse",lvl:1}]} 1
item replace entity @s[tag=enderman,tag=!selectedclass] armor.chest with leather_chestplate{Unbreakable: 1b, display: {color: 0}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=enderman,tag=!selectedclass] armor.legs with leather_leggings{Unbreakable: 1b, display: {color: 0}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=enderman,tag=!selectedclass] armor.feet with leather_boots{Unbreakable: 1b, display: {color: 0}, Enchantments: [{id: "blast_protection", lvl: 4},{id: "protection", lvl: 1}, {id: "binding_curse", lvl: 1}]} 1
