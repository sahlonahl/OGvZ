...
team join zZOMBIE @s[tag=zombie,tag=!selectedclass]
clear @s[tag=!selectedclass]

give @s[tag=zombie,tag=!selectedclass] cooked_beef 64
give @s[tag=zombie,tag=!selectedclass] iron_sword{Unbreakable:1b,Enchantments:[{id:"sharpness",lvl:3}]}
give @s[tag=zombie,tag=!selectedclass] iron_axe{Unbreakable:1b,Enchantments:[{id:"sharpness",lvl:3}]}
...
item replace entity @s[tag=zombie,tag=!selectedclass] armor.chest with leather_chestplate{Unbreakable: 1b, display: {color: 44975}, Enchantments: [{id: "blast_protection", lvl: 4}, {id: "binding_curse", lvl: 1}, {id: "protection", lvl: 3}], AttributeModifiers: [{Slot: "chest", AttributeName: "generic.armor", Name: "generic.armor", Amount: 6.0d, Operation: 0, UUID: [I; 64585, -64804, 64804, 64804]}]}
item replace entity @s[tag=zombie,tag=!selectedclass] armor.legs with leather_leggings{Unbreakable: 1b, display: {color: 4602533}, Enchantments: [{id: "blast_protection", lvl: 4}, {id: "binding_curse", lvl: 1}, {id: "protection", lvl: 3}], AttributeModifiers: [{Slot: "legs", AttributeName: "generic.armor", Name: "generic.armor", Amount: 5.0d, Operation: 0, UUID: [I; 64585, 64804, -64804, 64804]}]}
item replace entity @s[tag=zombie,tag=!selectedclass] armor.feet with leather_boots{Unbreakable: 1b, display: {color: 4602533}, Enchantments: [{id: "blast_protection", lvl: 4}, {id: "binding_curse", lvl: 1}, {id: "protection", lvl: 3}], AttributeModifiers: [{Slot: "feet", AttributeName: "generic.armor", Name: "generic.armor", Amount: 2.0d, Operation: 0, UUID: [I; 64585, 64804, 64804, -64804]}]}
