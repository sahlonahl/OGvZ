...
item replace entity @s[tag=golem,tag=!selectedclass] armor.head with firework_star{CustomModelData:8,display:{Name:'{"text":"Golem Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:4},{id:"protection",lvl:3},{id:"binding_curse",lvl:1}]} 1
item replace entity @s[tag=golem,tag=!selectedclass] armor.chest with iron_chestplate{Unbreakable: 1b, Enchantments: [{id: "blast_protection", lvl: 4}, {id: "protection", lvl: 3}, {id: "binding_curse", lvl: 1}],AttributeModifiers:[{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Amount:0.5,Operation:0,UUID:[I;-795877646,-574667296,-1983472701,-341701748]}]} 1
