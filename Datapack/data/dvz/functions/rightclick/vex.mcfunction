...
give @s[tag=vex,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Etheral Form","color":"#B5E4FF"}',Lore:['{"text":"Briefly fly where you are looking,","color":"gray","bold":false,"italic":false}','{"text":"passing through walls!","color":"gray","bold":false,"italic":false}','{"text":"20 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:84} 1
give @s[tag=vex,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Phantom Killer","color":"#B5E4FF"}',Lore:['{"text":"Doubles the damage of your","color":"gray","bold":false,"italic":false}','{"text":"next melee attack you deal","color":"gray","bold":false,"italic":false}','{"text":"10 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:85} 1
...
item replace entity @s[tag=vex,tag=!selectedclass] armor.feet with leather_boots{display:{color:10736127},Unbreakable: 1b, Enchantments: [{id: "feather_falling", lvl: 2},{id: "blast_protection", lvl: 4},{id: "binding_curse", lvl: 1}]} 1
