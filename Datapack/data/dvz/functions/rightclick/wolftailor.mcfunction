...
item replace entity @s[tag=wolf,tag=!selectedclass] armor.head with firework_star{CustomModelData:14,display:{Name:'{"text":"Wolf Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:4},{id:"protection",lvl:3},{id:"binding_curse",lvl:1}]} 1
