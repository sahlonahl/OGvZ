...
item replace entity @s[tag=wolf,tag=!selectedclass] armor.head with firework_star{CustomModelData:14,display:{Name:'{"text":"Wolf Head","italic":false}'},Unbreakable:1b,Enchantments:[{id:"blast_protection",lvl:4},{id:"protection",lvl:2},{id:"binding_curse",lvl:1}]} 1
item replace entity @s[tag=wolf,tag=!selectedclass] armor.chest with chainmail_chestplate{Unbreakable: 1b, display: {color: 14539483}, AttributeModifiers: [{Slot: "chest", AttributeName: "generic.armor", Name: "generic.armor", Amount: 5.0d, Operation: 0, UUID: [I; 64800, -64800, 64800, 64800]}], Enchantments: [{id: "blast_protection", lvl: 4}, {id: "protection", lvl: 2}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=wolf,tag=!selectedclass] armor.legs with chainmail_leggings{Unbreakable: 1b, display: {color: 13289416}, AttributeModifiers: [{Slot: "legs", AttributeName: "generic.armor", Name: "generic.armor", Amount: 4.0d, Operation: 0, UUID: [I; 64800, 64800, -64800, 64800]}], Enchantments: [{id: "blast_protection", lvl: 4}, {id: "protection", lvl: 2}, {id: "binding_curse", lvl: 1}]} 1
item replace entity @s[tag=wolf,tag=!selectedclass] armor.feet with chainmail_boots{Unbreakable: 1b, display: {color: 11578023}, AttributeModifiers: [{Slot: "feet", AttributeName: "generic.armor", Name: "generic.armor", Amount: 1.0d, Operation: 0, UUID: [I; 64800, 64800, 64800, -64800]}], Enchantments: [{id: "blast_protection", lvl: 4}, {id: "protection", lvl: 2}, {id: "binding_curse", lvl: 1}]} 1
