...
give @s[tag=bat,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Shroud of Night","color":"#331A00","bold":false,"italic":false}',Lore:['{"text":"Give nearby dwarves blindness and cleanse their buffs","color":"gray","bold":false,"italic":false}','{"text":"40 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:116} 1
