...
item replace entity @s[tag=bat,tag=!selectedclass] armor.feet with leather_boots{display:{color:3348992},Unbreakable:1b,Enchantments:[{id:"minecraft:blast_protection",lvl:4s},{id:"minecraft:binding_curse",lvl:1s}]} 1
