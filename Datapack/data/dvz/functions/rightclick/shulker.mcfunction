...
give @s[tag=shulker,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Conjure Trap","color":"#CE8FFF","bold":false,"italic":false}',Lore:['{"text":"Throw a projectile that spawns","color":"gray","bold":false,"italic":false}','{"text":"a temporary cage around landing point","color":"gray","bold":false,"italic":false}','{"text":"22 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:112} 1
give @s[tag=shulker,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Conjure Bomb","color":"#CE8FFF","bold":false,"italic":false}',Lore:['{"text":"Throw a projectile that spawns","color":"gray","bold":false,"italic":false}','{"text":"a bomb that can levitate players","color":"gray","bold":false,"italic":false}','{"text":"25 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:113} 1
