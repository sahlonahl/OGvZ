...
give @s[tag=zenchanter,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Fungal Ritual","color":"#FF0000"}',Lore:['{"text":"Press down rightclick to empower a nearby","color":"gray","bold":false,"italic":false}','{"text":"monster (at a certain price...)","color":"gray","bold":false,"italic":false}','{"text":"1 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:93,Enchantments:[{id:"minecraft:sharpness",lvl:6s},{id:"minecraft:knockback",lvl:2s}]} 1
