...
give @s[tag=magma_cube,tag=!selectedclass] golden_sword{Enchantments:[{id:"minecraft:sharpness",lvl:3s},{id:"minecraft:fire_aspect",lvl:1s},{id:"minecraft:unbreaking",lvl:3s}],Unbreakable:1b} 1
give @s[tag=magma_cube,tag=!selectedclass] carrot_on_a_stick{display:{Name:'{"text":"Infernal Grenade","color":"#451000"}',Lore:['{"text":"Throw a projectile that spawns","color":"gray","bold":false,"italic":false}','{"text":"3 large magma cubes","color":"gray","bold":false,"italic":false}','{"text":"25 second cooldown!","color":"red","bold":false,"italic":false}']},Unbreakable:1b,CustomModelData:94} 1
