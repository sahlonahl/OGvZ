...
execute if entity @s[tag=dwarves,scores={DVZ.legend.shard=..4},tag=!lbookused] run tellraw @s {"text":" * [Legendary Book] You need at least 5 Legendary Shards!","color":"gold"}
execute if entity @s[tag=lbookused] run tellraw @s {"text":" * [Legendary Book] You can only craft Legendary items once!","color":"gold"}
