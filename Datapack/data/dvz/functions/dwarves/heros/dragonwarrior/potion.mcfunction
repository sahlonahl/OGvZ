...
execute as @s if entity @s[tag=dwarves,tag=!playerboss,level=30..] run playsound minecraft:entity.witch.drink master @a ~ ~ ~ 1
execute as @s if entity @s[tag=dwarves,tag=!playerboss,level=30..] run playsound minecraft:entity.wandering_trader.reappeared master @a ~ ~ ~