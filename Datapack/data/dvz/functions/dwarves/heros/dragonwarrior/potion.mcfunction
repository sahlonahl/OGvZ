...
execute if entity @s[tag=dwarves,tag=!playerboss,level=..29] run tellraw @s {"text":" * [Ultimate Potion] You need at least 30 Mana!","color":"dark_red"}
execute if entity @s[tag=playerboss,level=..29] run tellraw @s {"text":" * YOU ARE TOO BLOODTHIRSTY TO DRINK.","color":"dark_red"}
...
execute as @s run tellraw @s[tag=dwarves,tag=!playerboss,level=30..] {"text":" * [Ultimate Potion] Poof!","color":"red"}
