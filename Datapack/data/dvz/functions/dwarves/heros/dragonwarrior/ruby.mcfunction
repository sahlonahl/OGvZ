...
execute as @s[tag=dragon,scores={DVZ.ruby.cool=1..}] run title @s actionbar ["",{"text":" * [Dwarven Ruby] You have ","color":"dark_red"},{"score":{"name":"@s","objective":"DVZ.ruby.cool"},"color":"dark_red"},{"text":" seconds remaining!","color":"dark_red"}]
execute if entity @s[tag=dragon,level=..29] run title @s actionbar {"text":" * [Dwarven Ruby] You need at least 30 Mana!","color":"dark_red"}
...
execute as @s[tag=RUBYuse] run title @s actionbar {"text":" * [Dwarven Ruby] Poof!","color":"red"}
