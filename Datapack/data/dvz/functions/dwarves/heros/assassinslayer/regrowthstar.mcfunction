...
execute as @s[tag=assassinslayer,scores={DVZ.rstar.cool=1..}] run title @s actionbar ["",{"text":" * [Regrowth Star] You have ","color":"gold"},{"score":{"name":"@s","objective":"DVZ.rstar.cool"},"color":"gold"},{"text":" seconds remaining!","color":"gold"}]
execute if entity @s[tag=assassinslayer,level=..4] run title @s actionbar {"text":" * [Regrowth Star] You need at least 5 Mana!","color":"gold"}
