...
execute if entity @s[tag=guardian,level=..29] run title @s actionbar {"text":" * [Mind\'s Eye] You need at least 30 Mana!","color":"dark_red"}
...
execute as @s run title @s[tag=guardian,level=30..] actionbar {"text":" * [Mind\'s Eye] Poof!","color":"red"}
