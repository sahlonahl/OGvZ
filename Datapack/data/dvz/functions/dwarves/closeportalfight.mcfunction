...
title @a actionbar ["",{"text":" * [Close Portal] ","color":"light_purple"},{"selector":"@s[type=player,tag=dwarves,tag=fight]","color":"light_purple"},{"text":" has closed the portal!","color":"light_purple"}]
