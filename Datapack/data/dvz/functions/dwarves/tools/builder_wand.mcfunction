...
execute as @s[tag=dwarves,scores={DVZ.flail.cool=1..}] run title @s actionbar ["",{"text":" * [Builder Wand] You have ","color":"gold"},{"score":{"name":"@s","objective":"DVZ.flail.cool"},"color":"gold"},{"text":" seconds remaining!","color":"gold"}]
execute if entity @s[tag=dwarves,level=..9] run title @s actionbar {"text":" * [Builder Wand] You need at least 15 Mana!","color":"gold"}
...
execute if entity @s[tag=FLAILuse] run title @s actionbar {"text":" * [Builder Wand] Poof!","color":"yellow"}
