...
# File Name: west
# File Purpose: places large structures west of builder.
...
execute as @e[name="Builder Bunker",type=minecraft:glow_squid] at @s run place template dvz:builder_bunker ~-6 ~ ~-3
...
execute as @e[name="Builder Platform",type=minecraft:glow_squid] at @s run place template dvz:builder_platform ~-1 ~ ~3 180
execute as @e[name="Builder Rampart",type=minecraft:glow_squid] at @s run place template dvz:builder_rampart ~-11 ~ ~-3
execute as @e[name="Builder Stable",type=minecraft:glow_squid] at @s run place template dvz:builder_stable ~-5 ~ ~-2
execute as @e[name="Builder Talltower",type=minecraft:glow_squid] at @s run place template dvz:builder_talltower ~-6 ~ ~-3
...
execute as @e[name="TNT Cannon",type=minecraft:glow_squid] at @s run place template dvz:ogvz_tnt_cannon ~-7 ~ ~-2
