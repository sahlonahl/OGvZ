...
execute if entity @s[tag=dwarves,level=..14] run tellraw @s {"text":" * [Strength Potion] You need at least 15 Mana!","color":"gold"}
...
execute as @s run tellraw @s[tag=dwarves,level=15..] {"text":" * [Strength Potion] Poof!","color":"yellow"}
