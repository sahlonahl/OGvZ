...
execute if entity @s[name="Ozald"] run title @a title ""
...
execute if entity @s[name="Astraeos_"] run title @a title ""
...
execute if entity @s[name="Muff1nArcades"] run title @a title ""
