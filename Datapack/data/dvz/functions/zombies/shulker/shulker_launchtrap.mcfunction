# -------------------------------------------
# Called By: shulker/shulker_throwtrap.mcfunction
# File Name: shulker_launchtrap
...
summon minecraft:armor_stand ^ ^1 ^1 {Silent:1b,Invulnerable:1b,ShowArms:0b,Small:1b,Invisible:1b,NoBasePlate:1b,Tags:["shulker_trap","shulker_projectile"],Rotation:[0F,0F],ArmorItems:[{},{},{},{id:"minecraft:end_stone",Count:1b}]}
