...
execute if entity @s[tag=pigman,scores={DVZ.pigeat.check=0,DVZ.pigeat.cool=0}] run tellraw @s {"text":" * [Eat] You can't eat this!","color":"dark_red"}
execute as @s[tag=pigman,scores={DVZ.pigeat.cool=1..}] run tellraw @s ["",{"text":" * [Eat] You can't eat that fast!","color":"dark_red"}]

execute if entity @s[tag=pigman,scores={DVZ.pigeat.check=1..,DVZ.pigeat.cool=0}] run tellraw @s {"text":" * [Eat] Nom!","color":"red"}
