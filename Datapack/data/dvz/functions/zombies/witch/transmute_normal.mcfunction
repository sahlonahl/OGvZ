...
give @s potion{display:{Name:'{"text":"Frog Potion","color":"green","bold":false,"italic":false}'},CustomPotionEffects:[{Id:1,Amplifier:0b,Duration:12000,ShowParticles:0b},{Id:8,Amplifier:2b,Duration:12000,ShowParticles:0b}],CustomPotionColor:65280} 1
