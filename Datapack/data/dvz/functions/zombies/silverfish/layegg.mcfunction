...
execute if entity @s[tag=silverfish,scores={DVZ.layegg.check=0}] run title @s actionbar {"text":" * [Lay Egg] You don't have any more eggs!","color":"dark_purple"}
execute as @s[tag=silverfish,scores={DVZ.layegg.cool=1..}] run title @s actionbar ["",{"text":" * [Lay Egg] You have ","color":"dark_purple"},{"score":{"name":"@s","objective":"DVZ.layegg.cool"},"color":"dark_purple"},{"text":" seconds remaining!","color":"dark_purple"}]
...
execute if entity @s[tag=silverfish,scores={DVZ.layegg.check=1..,DVZ.layegg.block=0,DVZ.layegg.cool=0}] run title @s actionbar {"text":" * [Lay Egg] You can't lay eggs here!","color":"dark_purple"}
execute if entity @s[tag=silverfish,scores={DVZ.layegg.check=1..,DVZ.layegg.block=1..,DVZ.layegg.cool=0}] run title @s actionbar {"text":" * [Lay Egg] Poof!","color":"light_purple"}
