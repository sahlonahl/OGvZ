...
summon creeper ~ ~ ~ {Team:"zMONSTER",ExplosionRadius:2b,Fuse:0,ignited:1b,CustomName:'{"text":"Endermine","color":"dark_purple","bold":false,"italic":false}'}
summon creeper ~ ~ ~ {Team:"zMONSTER",ExplosionRadius:2b,Fuse:2,ignited:1b,CustomName:'{"text":"Endermine","color":"dark_purple","bold":false,"italic":false}'}
kill @s
