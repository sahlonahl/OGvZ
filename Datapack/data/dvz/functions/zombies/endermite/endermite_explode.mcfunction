...
execute as @s at @s if entity @e[type=marker,tag=dSpawn,distance=..8] run summon creeper ~ ~ ~ {Team:"zMONSTER",ExplosionRadius:2b,Fuse:0,ignited:1b,CustomName:'{"text":"Endermine","color":"dark_purple","bold":false,"italic":false}'}
kill @s
