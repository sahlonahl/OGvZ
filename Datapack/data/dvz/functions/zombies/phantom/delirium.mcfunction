...
execute as @s[tag=phantom,scores={DVZ.delir.cool=1..}] run title @s actionbar ["",{"text":" * [Delirium] You have ","color":"dark_red"},{"score":{"name":"@s","objective":"DVZ.delir.cool"},"color":"dark_red"},{"text":" seconds remaining!","color":"dark_red"}]
execute as @s if entity @s[tag=phantom,scores={DVZ.delir.cool=0}] run title @s actionbar {"text":" * [Delirium] Poof!","color":"red"}
