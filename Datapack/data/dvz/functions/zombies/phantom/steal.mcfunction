...
execute as @s[tag=phantom,scores={DVZ.steal.cool=1..}] run tellraw @s ["",{"text":" * [Steal] You have ","color":"dark_red"},{"score":{"name":"@s","objective":"DVZ.steal.cool"},"color":"dark_red"},{"text":" seconds remaining!","color":"dark_red"}]

execute as @s if entity @s[tag=phantom,scores={DVZ.steal.cool=0}] run tellraw @s {"text":" * [Steal] Poof!","color":"red"}
