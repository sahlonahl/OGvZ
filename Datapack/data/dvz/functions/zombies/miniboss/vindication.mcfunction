...
execute as @s[tag=johnny,scores={DVZ.vindic.cool=0}] run teleport @a[tag=!miniboss,tag=!purplemob,tag=!pigman,tag=zombies] @s
execute as @s[tag=johnny,scores={DVZ.vindic.cool=0}] run effect give @a[tag=!miniboss,tag=!purplemob,tag=!pigman,tag=zombies] resistance 20
execute as @s[tag=johnny,scores={DVZ.vindic.cool=0}] run effect give @s resistance 20 1
