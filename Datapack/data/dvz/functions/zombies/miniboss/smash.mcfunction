...
execute as @s[tag=ravager,scores={DVZ.smash.cool=1..}] run tellraw @s ["",{"text":" * [Smash] You can' smash that fast!","color":"dark_purple"}]
execute if entity @s[tag=ravager,scores={DVZ.smash.cool=0},tag=!smashable] run tellraw @s {"text":" * [Smash] You can't smash here!","color":"dark_purple"}
...
execute if entity @s[tag=ravager,scores={DVZ.smash.cool=0},tag=smashable] run tellraw @s {"text":" * [Smash] Poof!","color":"light_purple"}
