...
execute as @s at @s if entity @s[tag=evoker,scores={DVZ.evokerward.cool=0}] run effect give @e[team=zMONSTER,distance=..15] resistance 20 0 true
execute as @s at @s if entity @s[tag=evoker,scores={DVZ.evokerward.cool=0}] run effect give @e[team=zMONSTER,distance=..15] absorption 20 4 true

execute as @s if entity @s[tag=evoker,scores={DVZ.evokerward.cool=0}] run scoreboard players set @s DVZ.evokerward.cool 35
