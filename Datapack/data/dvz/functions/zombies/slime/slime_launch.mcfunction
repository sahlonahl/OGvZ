...
summon area_effect_cloud ^ ^ ^1 {Tags:["slime_direction"]}
...
execute store result score #targetX pos as @e[type=area_effect_cloud,tag=slime_direction,limit=1] run data get entity @s Pos[0] 2500
execute store result score #targetY pos as @e[type=area_effect_cloud,tag=slime_direction,limit=1] run data get entity @s Pos[1] 2500
execute store result score #targetZ pos as @e[type=area_effect_cloud,tag=slime_direction,limit=1] run data get entity @s Pos[2] 2500
