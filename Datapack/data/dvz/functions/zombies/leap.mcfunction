...
# golem leap
execute as @s[tag=golem,scores={DVZ.leap.cool=1..}] run title @s actionbar ["",{"text":" * [Leap] You have ","color":"dark_red"},{"score":{"name":"@s","objective":"DVZ.leap.cool"},"color":"dark_red"},{"text":" seconds remaining!","color":"dark_red"}]
execute as @s if entity @s[tag=golem,scores={DVZ.leap.cool=0}] run title @s actionbar {"text":" * [Leap] Poof!","color":"red"}
...
# phantom leap
execute as @s[tag=phantom,scores={DVZ.leap.cool=1..}] run title @s actionbar ["",{"text":" * [Leap] You have ","color":"dark_red"},{"score":{"name":"@s","objective":"DVZ.leap.cool"},"color":"dark_red"},{"text":" seconds remaining!","color":"dark_red"}]
execute as @s if entity @s[tag=phantom,scores={DVZ.leap.cool=0}] run title @s actionbar {"text":" * [Leap] Poof!","color":"red"}
