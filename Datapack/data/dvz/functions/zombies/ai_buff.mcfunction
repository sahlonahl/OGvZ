...
data merge entity @s[type=zombie,tag=!endermine,tag=!piglin_charge,tag=!AIbuffed] {HandItems:[{id:"minecraft:wooden_sword",Count:1b},{}],HandDropChances:[0.000F,0.085F]}
