...
# effect give @a[tag=ogvz.dwarf.last_dwarf,tag=!ogvz.dwarf.class.hero] minecraft:resistance infinite 0 true
effect give @a[tag=ogvz.dwarf.last_dwarf,tag=!ogvz.dwarf.class.hero] minecraft:regeneration infinite 1 true
effect give @a[tag=ogvz.dwarf.last_dwarf,tag=!ogvz.dwarf.class.hero] minecraft:speed infinite 1 true
effect give @a[tag=ogvz.dwarf.last_dwarf,tag=!ogvz.dwarf.class.hero] minecraft:strength infinite 0 true
...
effect give @a[tag=ogvz.zombie,tag=!ogvz.zombie.class] minecraft:blindness infinite 0 true
