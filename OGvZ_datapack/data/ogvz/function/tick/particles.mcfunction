...
execute as @a[tag=ogvz.dwarf] at @n[type=minecraft:marker,tag=ogvz.marker.shrine] if predicate {condition:"entity_properties",entity:"this",predicate:{distance:{horizontal:{min:118}}}} at @s run particle minecraft:raid_omen ~ ~0.9 ~ 1 1 1 0 2
execute as @s[tag=ogvz.dwarf] at @n[type=minecraft:marker,tag=ogvz.marker.shrine] if predicate {condition:"entity_properties",entity:"this",predicate:{distance:{horizontal:{min:118}}}} at @s run particle dust{color:[0.9,0.0,0.0],scale:1} ~ ~ ~ 1 2 1 0.2 2 force
