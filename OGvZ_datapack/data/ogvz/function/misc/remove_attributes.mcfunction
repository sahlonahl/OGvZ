...
tag @s remove ogvz.attribute.zombie_spawn.fall_damage_multiplier
attribute @s minecraft:fall_damage_multiplier modifier remove ogvz:zombie_spawn.fall_damage_multiplier
...
attribute @s minecraft:block_break_speed modifier remove ogvz:golem.block_break_speed
