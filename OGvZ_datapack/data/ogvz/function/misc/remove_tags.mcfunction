...
tag @s remove ogvz.zombie.class.miniboss.johnny

tag @s remove ogvz.zombie.class.boss
tag @s remove ogvz.zombie.class.boss.dragon
tag @s remove ogvz.zombie.class.boss.wither
