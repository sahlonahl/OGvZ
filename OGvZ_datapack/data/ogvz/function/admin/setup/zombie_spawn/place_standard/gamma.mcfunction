...
execute at @s align xyz positioned ~0.5 ~ ~0.5 run summon minecraft:marker ~ ~ ~ {Tags:["ogvz.marker.zombie_spawn","ogvz.marker.zombie_spawn.gamma","ogvz.kill_on_reload"]}

# Summon a zombie spawn gamma seat marker.
execute at @s align xyz positioned ~0.5 ~0.6 ~0.5 run summon minecraft:item_display ~ ~ ~ {Tags:["ogvz.item_display.zombie_spawn_seat","ogvz.item_display.zombie_spawn_seat.gamma","ogvz.kill_on_reload"]}
...
execute at @s align xyz positioned ~0.25 ~0.25 ~0.25 run summon minecraft:block_display ~ ~ ~ { \
  Tags:["ogvz.block_display.zombie_spawn","ogvz.block_display.zombie_spawn.gamma","ogvz.kill_on_reload"], \
...
execute at @s align xyz positioned ~0.5 ~1.0 ~0.5 run summon minecraft:text_display ~ ~ ~ { \
  Tags:["ogvz.text_display.zombie_spawn","ogvz.text_display.zombie_spawn.gamma","ogvz.kill_on_reload"], \
  text:"Gamma", \
  billboard:"center" \
}
